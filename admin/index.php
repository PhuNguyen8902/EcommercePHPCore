        ...
        <div class="row">
            <div class="col-md-12 bg-secondary p-1 d-flex align-items-center">
                ...
                <div class="button text-center">
                    ...
                    <button class="me-2">
                        <a href="/admin/index.php?insert_category" class="nav-link text-light bg-info my-1 p-2">Insert
                            Categories</a>
                    </button>
                    <button class="me-2">
                    ...
                    <button class="me-2">
                        <a href="/admin/index.php?insert_brand" class="nav-link text-light bg-info my-1 p-2">Insert
                            Brands</a>
                    </button>
                    <button class="me-2">
